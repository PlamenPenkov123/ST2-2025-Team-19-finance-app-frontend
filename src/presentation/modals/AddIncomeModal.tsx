...
export const AddIncomeModal = (props: {
    ...
    const [incomeCategory, setIncomeCategory] = createSignal<string | undefined>(undefined);

    const [incomeCategories, setIncomeCategories] = createSignal<{ name: string; slug: string }[]>([]);
    ...
    const onSubmit = async () => {
        ...
        try {
            ...
            console.log(`Nigga date: ${formattedDate}`)
                    ...
                    >
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onInput={(e) => setIncomeCategory(e.currentTarget.value)}
                                required
                                class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm sm:text-base bg-white focus:outline-none focus:ring-2 focus:ring-[#C9DABD] transition"
                            >
